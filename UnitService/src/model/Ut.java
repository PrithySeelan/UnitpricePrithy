...
public class Ut {
  ...
  public String readItems()
  {
    String output = "";
      ...
      {  
        ...
        output = "<table border='1'><tr><th>unitID</th><th>District</th><th>unitPrice</th>" ;
      ...
      //  output += "<td><input name='btnUpdate' 
        	...
        	//	 <td><form method='post' action='Ut.jsp'>
        	//	 <input name='btnRemove' type='submit' 
        	//	 value='Remove' class='btn btn-danger'>
        	//	 <input name='hidunitIDDelete' type='hidden' 
  ...
  public String updateItem(String unitID, String dist, String unitp)
  {
    String output = "";
      try
      {
...
preparedStmt.setString(1, dist);
        preparedStmt.setString(2, unitp);
        preparedStmt.setInt(3, Integer.parseInt(unitID));
